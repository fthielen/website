...
[design.background]
  ...
  # Background image.
  image = "headers/cover_small2.jpg"  # Name of image in `static/img/`.
...
In the spirit of this website, you can download a PDF version of my [dissertation](files/cv.pdf), and its [online Appendix](files/cv.pdf) for educational purposes.
